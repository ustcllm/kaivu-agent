...
class ScientificRuntimeHarness:
    def __init__(self, *, root: str | Path, trajectory_dir: str | Path | None = None) -> None:
        ...
        self.runtime_dir = self.root / ".scientific_agent_runtime"
        ...
        *,
        ...
        stream.emit(
            ...
            payload={
                ...
                "evaluation_release_state": getattr(result, "research_state", {}).get("scientific_agent_evaluation_harness_summary", {}).get("release_state", ""),
        ...
        trajectory = RuntimeTrajectory(
            ...
            evaluation_summary=getattr(result, "research_state", {}).get("scientific_agent_evaluation_harness_summary", {}),
        )
