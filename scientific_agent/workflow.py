...
from .evaluation_harness import build_scientific_agent_evaluation_harness_summary
...
class ScientificWorkflow:
    def __init__(
        ...
        *,
        ...
        self.graph_registry = ResearchGraphRegistry(self.cwd / ".scientific_agent_graph")
        self.event_ledger = ResearchEventLedger(self.cwd / ".scientific_agent_events")
        self.experiment_registry = ExperimentRegistry(self.cwd / ".scientific_agent_experiments")
    ...
    async def run(
        ...
        *,
        ...
        claim_graph["scientific_agent_evaluation_harness_summary"] = research_state.get(
            "scientific_agent_evaluation_harness_summary", {}
        )
        ...
        research_state["scientific_evaluation_system_summary"] = ScientificWorkflow._derive_scientific_evaluation_system_summary(
            ...
            scientific_agent_evaluation_harness_summary=research_state.get("scientific_agent_evaluation_harness_summary", {}),
    ...
    def _derive_research_state(
        ...
        *,
        ...
        scientific_agent_evaluation_harness_summary = (
            build_scientific_agent_evaluation_harness_summary(
                topic=topic,
                project_id=str(self.collaboration_context.get("project_id", "")).strip(),
                evaluation_summary=evaluation_summary,
                benchmark_harness_summary=benchmark_harness_summary,
        ...
        unified_asset_summary = build_unified_asset_summary(
            ...
            execution_adapter_registry_summary=execution_adapter_registry_summary,
            run_handoff_contract_summary=run_handoff_contract_summary,
            scientific_agent_evaluation_harness_summary=scientific_agent_evaluation_harness_summary,
            causal_graph_summary=causal_graph_summary,
        )
        kernel_state = {
            "topic": topic,
    ...
    def _derive_scientific_evaluation_system_summary(
        *,
        ...
        scientific_agent_evaluation_harness_summary: dict[str, Any],
        evaluation_summary: dict[str, Any],
    ) -> dict[str, Any]:
        ...
        blocking_gates = ScientificWorkflow._strings(
            scientific_agent_evaluation_harness_summary.get("blocking_gates", [])
        )
        ...
        release_state = str(scientific_agent_evaluation_harness_summary.get("release_state", "")).strip()
        ...
        return {
            ...
            "overall_score": scientific_agent_evaluation_harness_summary.get("overall_score", 0),
            ...
            "canonical_layers": {
                ...
                "agent_evaluation_harness": scientific_agent_evaluation_harness_summary,
    ...
    def _sync_research_strategy_memories(self, research_state: dict[str, Any]) -> None:
        ...
        evaluation_harness = research_state.get("scientific_agent_evaluation_harness_summary", {})
        if isinstance(evaluation_harness, dict) and evaluation_harness:
            manager.save_memory(
                title=f"Scientific agent evaluation harness: {research_state.get('topic', 'research thread')}",
                summary=(
                ...
                filename="scientific-agent-evaluation-harness.md",
                source_refs=[
                    str(axis.get("axis_id", "")).strip()
                    for axis in evaluation_harness.get("axes", [])
                ...
                visibility="project",
                promotion_status="project",
                tags=["scientific-agent-evaluation", "regression-suite", "release-gate"],
                validated_by=["workflow:scientific-agent-evaluation-harness"],
            )
