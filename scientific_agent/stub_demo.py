...
if __package__ in (None, ""):
    ...
    from scientific_agent.data_tools import BasicStatsTool, ReadTableTool
    from scientific_agent.engine import ScientificAgent
    from scientific_agent.memory import MemoryManager
    from scientific_agent.model import StubScienceModel
